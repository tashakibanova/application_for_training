...
const COURSE_SECTIONS = {
  ...
  // Сколково / Сколково: ПП — по просьбе заказчика без отдельной вкладки-папки
  // в попапе выбора курса: folder: null => курсы доступны только через «Все
  // папки» и поиск (courseFolders() в site/app.js отбрасывает null-папки).
  1308: { name: 'ЕРЛ Сколково', category: null, folder: null },
  1330: { name: 'ЕРЛ Сколково: ПП', category: null, folder: null },
};
